...
export class Authentication {
  ...
  // Save our tokento our Storage provider.
  // NOTE: For this application we have decided that we will name
  //  the key for our token 'travlr-token'
  ...
  // still valid. Even if we have a token we wil still have to 
  ...
  // after the calling method has checked to make suer that the user
  // isLoggedIn.
  ...
  // Because that method returns an observable, we subscribe th the
